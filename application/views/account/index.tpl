...
<div class="response_row toolbar">
 <input id="search-input" type="text" class="form-control" placeholder="{lang}User Name/Company/Email{/lang}">
...
$(function(){
  ...
  if ($("#datatable").length > 0) {
    $("#datatable").on('iframe.ready', function(e, tr, doc){
      doc.find('#btn-save').click(function(){
        doc.find("#user-form").submit();
