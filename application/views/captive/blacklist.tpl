...
{block name=workbench}
  <div class="response_row toolbar">
    ...
    <input id="search-input" type="text" class="form-control" placeholder="{lang}Serial ID/User Name{/lang}">
    <a id="search-btn" class="btn pinet-btn-green search">{lang}Search{/lang}</a>
    <a id="delete-btn" class="btn pinet-btn-blue delete">{lang}Delete{/lang}</a>
